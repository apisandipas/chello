  ...
  if (!isEditing && !description) {
    return (
      <div className="flex flex-col gap-2">
        ...
        <div
          className="flex flex-col gap-2 bg-gray-100 rounded-md p-2 min-h-[100px] cursor-pointer hover:bg-gray-200"
